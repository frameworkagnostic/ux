...
const toArray = (props) => (Array.isArray(props) ? props : [props]);
...
export default {
  ...
  create(
    ...
    return toArray(props).map((animatedProp) => `${animatedProp} ${
      typeof durationOption === 'string' ? durationOption : formatMs(durationOption)
    } ${easingOption} ${typeof delay === 'string' ? delay : formatMs(delay)}`).join(',');
  },
